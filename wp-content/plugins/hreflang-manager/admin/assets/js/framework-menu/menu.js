	...
	function ($) {
		...
		$( document.body ).on(
			...
			function () {
				...
				$( '.dahm-main-form__daext-form-section-body[data-section-id="' + target + '"]' ).toggleClass( 'dahm-main-form__daext-form-section-body-opened' );
		...
		$( document.body ).on(
			'mouseenter',
			'.dahm-admin-toolbar__menu-item-more',
			function () {
				$( '.dahm-admin-toolbar__pop-sub-menu' ).show();
			}
		);

		$( document.body ).on(
			'mouseleave',
			'.dahm-admin-toolbar__menu-item-more, .dahm-admin-toolbar__pop-sub-menu',
			function () {
				$( '.dahm-admin-toolbar__pop-sub-menu' ).hide();
			}
		);
		...
		$( document ).on(
			'change',
			'.dahm-bulk-action-checkbox',
			function () {
				let selectedItems = [];
				$( '.dahm-bulk-action-checkbox:checked' ).each(
					function () {
